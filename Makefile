...
proxmoxer-stubs: poetry clean-stubs ## Create stubs
	...
	poetry run python3 -m stubgen --config apidata/apidata.json --stubs proxmoxer-stubs/core.pyi ; \
...
proxmoxer_types: poetry clean-types ## Create type containers
	...
	for V in $(VERSIONS) ; do \
		...
		poetry run python3 -m stubgen --config apidata/apidata-$$V.json --types proxmoxer_types/$$V/core.py ; \
	done
